...
export default function MobileActionBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[60] border-t border-stone-200 bg-white/95 px-2.5 py-1.5 backdrop-blur md:hidden">
      <div className="mx-auto grid max-w-7xl grid-cols-3 gap-2">
        ...
        <a
          ...
          className="inline-flex h-10 items-center justify-center gap-1 rounded-xl border border-stone-300 bg-white px-2 text-[11px] font-semibold text-ink-900"
        >
